...
<template>
    <div class="relative my-10 w-[335px] lg:w-[730px] h-[200px] lg:h-[500px]">
        ...
        <div class="absolute left-[10px] top-[50%] z-11 translate-y-[-50%] fix-safari-3D cursor-pointer" @click="changeSlide(show-1)">
        ...
        <div class="absolute right-[10px] top-[50%] z-11 translate-y-[-50%] fix-safari-3D cursor-pointer" @click="changeSlide(show+1)">
        ...
        <div class="absolute left-[40%] bottom-[20px] lg:bottom-[30px] flex gap-5 lg:gap-3 translate-x-[-50%] translate-y-[-50%] h-[10px] z-11 fix-safari-3D">
            <span class="cursor-pointer" @click="changeSlide(index-1)" v-for="index in imgs.length" :key="index" :class="{ active: show === index-1 }">
